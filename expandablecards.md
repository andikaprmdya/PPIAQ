# Expandable Cards
URL: /docs/cards/expandable-cards
...
<ComponentPreview name="expandable-product-card" classNameComponentContainer="min-h-[550px]" code={(await extractSourceCode("expandable-product-card")).code} lang="tsx" hasReTrigger={true} />
...
<Steps>
  ...
  <Step>
    ...
    <ComponentSource code={(await extractSourceCode("expandable-product-card")).code} className="bg-fd-secondary/50" />
  </Step>
</Steps>
...
<ComponentPreview name="expandable-weather-card" classNameComponentContainer="min-h-[450px]" code={(await extractSourceCode("expandable-weather-card")).code} lang="tsx" hasReTrigger={true} />

#### Copy the Weather Card Component

<ComponentSource code={(await extractSourceCode("expandable-weather-card")).code} className="bg-fd-secondary/50" />
...
<ComponentPreview name="expandable-meeting-card" classNameComponentContainer="min-h-[500px]" code={(await extractSourceCode("expandable-meeting-card")).code} lang="tsx" hasReTrigger={true} />

#### Copy the Meeting Card Component

<ComponentSource code={(await extractSourceCode("expandable-meeting-card")).code} className="bg-fd-secondary/50" />
