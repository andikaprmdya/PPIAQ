...
export default function HomeContentPage() {
  ...
  const availableSections = [
    ...
    { key: 'features_title', label: 'Features Title', section: 'features' },
    { key: 'features_description', label: 'Features Description', section: 'features' },
    { key: 'cta_title', label: 'Call to Action Title', section: 'cta' },
    { key: 'cta_description', label: 'CTA Description', section: 'cta' },
  ];
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-8">
        <h1 className="font-tan-angleton font-bold text-3xl text-[#B64847] mb-2">Home Page Content</h1>
        <p className="text-[#886644] text-sm">Edit sections of your home page with bilingual support</p>
      </div>
            ...
            return (
              <div key={sectionConfig.key} className="bg-white border border-[#E4DBCA] rounded-2xl p-6 hover:shadow-lg transition-all">
                <div className="flex justify-between items-start">
                  ...
                  <button
                    onClick={() => handleEditSection(existingContent || { id: '', key: sectionConfig.key, section: sectionConfig.section, content: { id: '', en: '' }, type: 'TEXT', page: 'home' })}
