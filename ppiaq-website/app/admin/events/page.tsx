  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="font-tan-angleton font-bold text-3xl text-[#B64847] mb-2">Manage Events</h1>
          <p className="text-[#886644] text-sm">Create, edit, and publish events for your community</p>
        </div>
